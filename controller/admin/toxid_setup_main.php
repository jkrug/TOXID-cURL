...
class toxid_setup_main extends oxAdminView
{
    ...
    public function render()
    {
        ...
        $this->_aViewData['aToxidCurlPreviewUrlParams']    = $oConf->getShopConfVar('aToxidCurlPreviewUrlParams');
    ...
    public function save()
    {
        ...
        $oConf->saveShopConfVar('arr', 'aToxidCurlPreviewUrlParams', $aParams['aToxidCurlPreviewUrlParams'], $sShopId, self::CONFIG_MODULE_NAME);
    }
}